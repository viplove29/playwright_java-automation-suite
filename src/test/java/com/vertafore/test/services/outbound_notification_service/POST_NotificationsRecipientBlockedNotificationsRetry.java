...
public class POST_NotificationsRecipientBlockedNotificationsRetry extends TokenSuperClass {

  String clientId;
  Actor AADM_User = theActorCalled("AADM_User");

  @Test
  public void postNotificationsRecipientBlockedNotificationsRetryReturnsUnblockedNotifications() {
    ...
    // update the recipient url
    String endPointURI = "https://botd-nsclient1.devop.vertafore.com:8083/notification";
    ...
    notificationRecipientPutRequest.setRecipientName(recipient.getName());
    notificationRecipientPutRequest.setStatus(recipient.getServiceStatus().getDescription());
    notificationRecipientPutRequest.setRecipientVersion(recipient.getVersion());
    notificationRecipientPutRequest.setRecipientEndPointURI(endPointURI);
    notificationRecipientPutRequest.setAuthenticationCode(recipient.getAuthenticationDetail());
    notificationRecipientPutRequest.setPrimaryContactId(recipient.getPrimaryContactId());
    ...
    // post notifications recipient blocked notifications
    UnblockNotificationRecipientPostRequest unblockRequest =
        new UnblockNotificationRecipientPostRequest();
    unblockRequest.setRecipientId(recipientId);
    AADM_User.attemptsTo(
        notificationsApi
            .POSTNotificationsRecipientBlockedNotificationsRetryOnTheOutboundnotificationserviceController(
                unblockRequest, ""));
    assertThat(SerenityRest.lastResponse().getStatusCode()).isEqualTo(200);

    UnblockNotificationRecipientResponse unblockRecipientResponse =
        LastResponse.received()
            .answeredBy(AADM_User)
            .getBody()
            .jsonPath()
            .getObject("", UnblockNotificationRecipientResponse.class);

    assertThat(unblockRecipientResponse).isNotNull();
    assertThat(unblockRecipientResponse.getNumberOfNotificationsUnblocked())
    ...
    if (!getBlockedNotificationsCallSuccess) {
      Assert.fail(
          "Blocked notifications are still present even after unblocking the notifications.");
    }
  }
  ...
  @Test
  public void postNotificationsRecipientBlockedNotificationsRetryBaselineTest() {
  ...
  @Test
  public void postNotificationsRecipientBlockedNotificationsRetryErrorTest() {
    ...
    Util.validateErrorResponseContainsString(
        "The string value of recipientId could not be parsed as the expected GUID.; The RecipientId field is required.",
        AADM_User);

    // Test blocked notifications recipient call with passing empty recipient Id
    unblockRequest = new UnblockNotificationRecipientPostRequest();
    unblockRequest.setRecipientId("");
    AADM_User.attemptsTo(
        notificationsApi
            .POSTNotificationsRecipientBlockedNotificationsRetryOnTheOutboundnotificationserviceController(
                unblockRequest, ""));
    ...
    unblockRequest = new UnblockNotificationRecipientPostRequest();
    unblockRequest.setRecipientId(recipientId1ToDelete);
    AADM_User.attemptsTo(
        notificationsApi
            .POSTNotificationsRecipientBlockedNotificationsRetryOnTheOutboundnotificationserviceController(
                unblockRequest, ""));
