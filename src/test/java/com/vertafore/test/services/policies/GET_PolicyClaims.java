...
public class GET_PolicyClaims extends TokenSuperClass {

  @Test
  public void getPolicyClaimsBaselineTest() {
    ...
    AADM_User.attemptsTo(policyAPI.GETPolicyClaimsOnThePoliciesController(policyId, ""));
    assertThat(SerenityRest.lastResponse().getStatusCode()).isEqualTo(200);

    ORAN_App.attemptsTo(policyAPI.GETPolicyClaimsOnThePoliciesController(policyId, ""));
    assertThat(SerenityRest.lastResponse().getStatusCode()).isEqualTo(200);

    VADM_Admin.attemptsTo(policyAPI.GETPolicyClaimsOnThePoliciesController(policyId, ""));
