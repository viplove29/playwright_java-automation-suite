...
public class GET_Submissions {
  ...
  public void submissionsSuccessfullyReturnsPoliciesForCustomer() {
    ...
    bob.attemptsTo(
        submissionsAPI.GETSubmissionsOnTheSubmissionsController(customerGUID, true, "string"));
  ...
  public void submissionsSuccessfullyReturnsAllSubmissionsForCustomer() {
    ...
    bob.attemptsTo(
        submissionsAPI.GETSubmissionsOnTheSubmissionsController(customerGUID, false, "string"));
