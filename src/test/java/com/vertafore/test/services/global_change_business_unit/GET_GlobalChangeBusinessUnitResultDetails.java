...
public class GET_GlobalChangeBusinessUnitResultDetails extends TokenSuperClass {
  ...
  public void getGlobalChangeBusinessUnitResultDetailsBaselineTest() {
    ...
    AADM_User.attemptsTo(
        globalChangeToApi
            .GETGlobalChangeBusinessUnitResultDetailOnTheBusinessunitglobalchangeController(
