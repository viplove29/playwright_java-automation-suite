...
public class POST_SMSVMBMessage extends TokenSuperClass {

  @Test
  public void postSMSVMBMessageBaselineTest() {
    ...
    VADM_Admin.attemptsTo(
        (smsAPI.POSTSmsVmbMessageOnTheVmbmessagessmsController(incomingVmbMessagePostRequest, "")));
