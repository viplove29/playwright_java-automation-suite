...
public class EmptyResponseV1   {
  ...
  public EmptyResponseV1 error(ErrorResponseV1 error) {
    this.error = error;
    return this;
  }
  ...
  **/
  ...
  public EmptyResponseV1 requestId(String requestId) {
  ...
  **/
  ...
  public EmptyResponseV1 spanId(String spanId) {
    this.spanId = spanId;
    return this;
  }
  ...
  **/
  ...
  public EmptyResponseV1 traceId(String traceId) {
