...
/** This class was automatically generated on 2020/03/30 11:17:03 */
public class UseRenderServiceTo {

  private static final String THIS_SERVICE = "render";

  public static Performable renderTemplateUsingPostOnTheDocumentController(
      Object body, String scope) {
    return Task.where(
        "{0} Render a template",
        actor -> {
          CallTitanApi.asActorUsingService(actor, THIS_SERVICE)
              ...
              .post("documents?scope=ancestors");
        });
  }

  public static Performable createTemplateUsingPostOnTheTemplateController(
  ...
  public static Performable searchEmailTemplatesUsingGetOnTheEmailTemplateController(
      String pageSize, String page, String emailPurpose, String templateName, String filter) {
    return Task.where(
        ...
        actor -> {
          CallTitanApi.asActorUsingService(actor, THIS_SERVICE)
              ...
              .queryParam("emailPurpose", emailPurpose)
              .queryParam("templateName", templateName)
              .queryParam("filter", filter)
              .get("email-templates?filter=byEmailPurposeAndTemplateName");
        });
  }

  public static Performable updateEmailTemplateUsingPutOnTheEmailTemplateController(
  ...
  public static Performable findAllEmailTemplatesUsingGetOnTheEmailTemplateController(
  ...
  public static Performable updateSignatureUsingPutOnTheSignatureController(
      String id, Object body) {
    return Task.where(
  ...
  public static Performable getSignatureForCurrentUserUsingGetOnTheSignatureController(
      String filterBy) {
    return Task.where(
        "{0} Get Email signature",
        actor -> {
          CallTitanApi.asActorUsingService(actor, THIS_SERVICE)
              ...
              .get("/render/v1/{productId}/{tenantId}/entities/");
        });
  }
