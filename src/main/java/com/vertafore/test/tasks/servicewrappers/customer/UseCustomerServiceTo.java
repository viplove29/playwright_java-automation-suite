...
public class UseCustomerServiceTo {
  ...
  private static final String GET_DISQUALIFICATION_REASONS_BY_CONTEXT_USING_GET =
      "disqualification-reasons";
  private static final String CREATE_ACCOUNT_USING_POST = "accounts";
  private static final String CREATE_SERVICE_TEAM_MEMBER_USING_POST =
  ...
  private static final String GET_LOCATIONS_PER_ACCOUNT_USING_GET =
      "accounts/{accountId}/locations";
  private static final String CONVERT_LEAD_USING_POST = "customers";
  private static final String GET_LEADS_BY_IDS_USING_GET =
      "leads?filter=byIds&scope=descendants{&pageSize,page,ids}";
  private static final String GET_CONTACTS_FOR_ACCOUNT_BY_ID_USING_GET =
      "accounts/{accountId}/contacts";
  private static final String CREATE_DISQUALIFICATION_REASON_USING_POST =
      "disqualification-reasons";
  private static final String CREATE_LEAD_USING_POST = "leads";
  private static final String GET_SERVICE_TEAM_MEMBERS_PER_ACCOUNT_USING_GET =
      "accounts/{accountId}/service-team-members";
  ...
  private static final String GET_ACCOUNTS_BY_IDS_USING_GET =
      "accounts?filter=byIds&scope=descendants{&pageSize,page,ids}";
  private static final String GET_CUSTOMERS_BY_SEARCH_TERM_USING_GET =
      "customers?filter=bySearchTerm&scope=descendants{&searchTerm,isDescending,sortField,pageSize,page}";
  ...
  private static final String SEARCH_LEADS_USING_GET =
      "leads?filter=bySearchTerm&scope=descendants{&searchTerm,isDescending,sortField,isDisqualified,pageSize,page}";
  private static final String CREATE_RELATED_ACCOUNT_USING_POST =
      "accounts/{accountId}/related-accounts";
  private static final String SEARCH_ACCOUNTS_USING_GET =
      "accounts?filter=bySearchTerm&scope=descendants{&searchTerm,isDescending,sortField,isDisqualified,pageSize,page}";
  private static final String PATCH_DISQUALIFICATION_REASON_USING_PATCH =
      "disqualification-reasons/{id}";
  private static final String GET_DISQUALIFICATION_REASON_BY_ID_USING_GET =
      "disqualification-reasons/{id}";
  private static final String DELETE_DISQUALIFICATION_REASON_USING_DELETE =
      "disqualification-reasons/{id}";
  private static final String UPDATE_DISQUALIFICATION_REASON_USING_PUT =
      "disqualification-reasons/{id}";
  ...
  private static final String GET_CUSTOMERS_BY_IDS_USING_GET =
      "customers?filter=byIds&scope=descendants{&pageSize,page,ids}";
  ...
  private static final String GET_RELATED_ACCOUNTS_USING_GET =
      "accounts/{accountId}/related-accounts";
  private static final String CREATE_DISQUALIFICATION_USING_POST =
      "leads/{leadId}/disqualification";
  private static final String DELETE_DISQUALIFICATION_ON_LEAD_USING_DELETE =
      "leads/{leadId}/disqualification";
  private static final String UPDATE_DISQUALIFICATION_ON_LEAD_USING_PUT =
      "leads/{leadId}/disqualification";
    ...
    return Task.where(
        ...
        actor -> {
          rest()
              ...
              .get(as(actor).toEndpoint(GET_LEAD_SOURCES_BY_CONTEXT_USING_GET));
        });
  }

  public static Performable getDisqualificationReasonsByContextUsingGet(
    ...
    return Task.where(
        ...
        actor -> {
          rest()
              ...
              .queryParam("pageSize", pageSize)
              .queryParam("page", page)
              .get(as(actor).toEndpoint(GET_DISQUALIFICATION_REASONS_BY_CONTEXT_USING_GET));
        });
  }
    ...
    return Task.where(
        ...
        actor -> {
          rest()
              ...
              .contentType("application/json")
              .body(body)
              .post(as(actor).toEndpoint(CREATE_ACCOUNT_USING_POST));
        });
  }
    ...
    return Task.where(
        ...
        actor -> {
          rest()
              ...
              .body(body)
              .post(as(actor).toEndpoint(CREATE_SERVICE_TEAM_MEMBER_USING_POST));
        });
  }
    ...
    return Task.where(
        ...
        actor -> {
          rest()
              ...
              .patch(as(actor).toEndpoint(PATCH_CUSTOMER_USING_PATCH));
        });
  }
    ...
    return Task.where(
        ...
        actor -> {
          rest()
              ...
              .contentType("application/json")
              .pathParam("customerId", customerId)
              .get(as(actor).toEndpoint(GET_CUSTOMER_USING_GET));
        });
  }
    ...
    return Task.where(
        ...
        actor -> {
          rest()
              ...
              .contentType("application/json")
              .pathParam("customerId", customerId)
              .delete(as(actor).toEndpoint(DELETE_CUSTOMER_USING_DELETE));
        });
  }
    ...
    return Task.where(
        ...
        actor -> {
          rest()
              ...
              .body(body)
              .pathParam("customerId", customerId)
              .put(as(actor).toEndpoint(UPDATE_CUSTOMER_USING_PUT));
        });
  }
    ...
    return Task.where(
        ...
        actor -> {
          rest()
              ...
              .patch(as(actor).toEndpoint(PATCH_LEAD_USING_PATCH));
        });
  }
    ...
    return Task.where(
        ...
        actor -> {
          rest()
              ...
              .contentType("application/json")
              .pathParam("leadId", leadId)
              .get(as(actor).toEndpoint(GET_LEAD_USING_GET));
        });
  }
    ...
    return Task.where(
        ...
        actor -> {
          rest()
              ...
              .contentType("application/json")
              .pathParam("leadId", leadId)
              .delete(as(actor).toEndpoint(DELETE_LEAD_USING_DELETE));
        });
  }
    ...
    return Task.where(
        ...
        actor -> {
          rest()
              ...
              .body(body)
              .pathParam("leadId", leadId)
              .put(as(actor).toEndpoint(UPDATE_LEAD_USING_PUT));
        });
  }

  public static Performable getLocationsPerAccountUsingGet(
    ...
    return Task.where(
        ...
        actor -> {
          rest()
              ...
              .queryParam("pageSize", pageSize)
              .queryParam("page", page)
              .get(as(actor).toEndpoint(GET_LOCATIONS_PER_ACCOUNT_USING_GET));
        });
  }
    ...
    return Task.where(
        ...
        actor -> {
          rest()
              ...
              .post(as(actor).toEndpoint(CONVERT_LEAD_USING_POST));
        });
  }

  public static Performable getLeadsByIdsUsingGet(
    ...
    return Task.where(
        ...
        actor -> {
          rest()
              ...
              .get(as(actor).toEndpoint(GET_LEADS_BY_IDS_USING_GET));
        });
  }

  public static Performable getContactsForAccountByIdUsingGet(
    ...
    return Task.where(
        ...
        actor -> {
          rest()
              ...
              .queryParam("page", page)
              .pathParam("accountId", accountId)
              .get(as(actor).toEndpoint(GET_CONTACTS_FOR_ACCOUNT_BY_ID_USING_GET));
        });
  }
    ...
    return Task.where(
        ...
        actor -> {
          rest()
              ...
              .contentType("application/json")
              .body(body)
              .post(as(actor).toEndpoint(CREATE_DISQUALIFICATION_REASON_USING_POST));
        });
  }
    ...
    return Task.where(
        ...
        actor -> {
          rest()
              ...
              .contentType("application/json")
              .body(body)
              .post(as(actor).toEndpoint(CREATE_LEAD_USING_POST));
        });
  }

  public static Performable getServiceTeamMembersPerAccountUsingGet(
      String accountId, String pageSize, String page) {
    return Task.where(
        ...
        actor -> {
          rest()
              ...
              .queryParam("pageSize", pageSize)
              .queryParam("page", page)
              .get(as(actor).toEndpoint(GET_SERVICE_TEAM_MEMBERS_PER_ACCOUNT_USING_GET));
        });
  }
    ...
    return Task.where(
        ...
        actor -> {
          rest()
              ...
              .body(body)
              .pathParam("id", id)
              .patch(as(actor).toEndpoint(PATCH_ACCOUNT_USING_PATCH));
        });
  }
    ...
    return Task.where(
        ...
        actor -> {
          rest()
              ...
              .contentType("application/json")
              .pathParam("id", id)
              .get(as(actor).toEndpoint(GET_ACCOUNT_BY_ID_USING_GET));
        });
  }
    ...
    return Task.where(
        ...
        actor -> {
          rest()
              ...
              .contentType("application/json")
              .pathParam("id", id)
              .delete(as(actor).toEndpoint(DELETE_ACCOUNT_USING_DELETE));
        });
  }
    ...
    return Task.where(
        ...
        actor -> {
          rest()
              ...
              .body(body)
              .pathParam("id", id)
              .put(as(actor).toEndpoint(UPDATE_ACCOUNT_USING_PUT));
        });
  }

  public static Performable getAccountsByIdsUsingGet(
      String pageSize, String page, String ids, String filter, String scope) {
    return Task.where(
        ...
        actor -> {
          rest()
              ...
              .queryParam("filter", filter)
              .queryParam("scope", scope)
              .get(as(actor).toEndpoint(GET_ACCOUNTS_BY_IDS_USING_GET));
        });
  }

  public static Performable getCustomersBySearchTermUsingGet(
      String searchTerm,
      String isDescending,
      String sortField,
      String pageSize,
    ...
    return Task.where(
        ...
        actor -> {
          rest()
              ...
              .queryParam("filter", filter)
              .queryParam("scope", scope)
              .get(as(actor).toEndpoint(GET_CUSTOMERS_BY_SEARCH_TERM_USING_GET));
        });
  }
    ...
    return Task.where(
        ...
        actor -> {
          rest()
              ...
              .body(body)
              .pathParam("id", id)
              .patch(as(actor).toEndpoint(PATCH_CONTACT_USING_PATCH));
        });
  }
    ...
    return Task.where(
        ...
        actor -> {
          rest()
              ...
              .contentType("application/json")
              .pathParam("id", id)
              .get(as(actor).toEndpoint(GET_CONTACT_USING_GET));
        });
  }
    ...
    return Task.where(
        ...
        actor -> {
          rest()
              ...
              .contentType("application/json")
              .pathParam("id", id)
              .delete(as(actor).toEndpoint(DELETE_CONTACT_USING_DELETE));
        });
  }
    ...
    return Task.where(
        ...
        actor -> {
          rest()
              ...
              .body(body)
              .pathParam("id", id)
              .put(as(actor).toEndpoint(UPDATE_CONTACT_USING_PUT));
        });
  }

  public static Performable searchLeadsUsingGet(
      String searchTerm,
      String isDescending,
      String sortField,
    ...
    return Task.where(
        ...
        actor -> {
          rest()
              ...
              .queryParam("filter", filter)
              .queryParam("scope", scope)
              .get(as(actor).toEndpoint(SEARCH_LEADS_USING_GET));
        });
  }
    ...
    return Task.where(
        ...
        actor -> {
          rest()
              ...
              .body(body)
              .pathParam("accountId", accountId)
              .post(as(actor).toEndpoint(CREATE_RELATED_ACCOUNT_USING_POST));
        });
  }

  public static Performable searchAccountsUsingGet(
      String searchTerm,
      String isDescending,
      String sortField,
      String isDisqualified,
    ...
    return Task.where(
        ...
        actor -> {
          rest()
              ...
              .queryParam("filter", filter)
              .queryParam("scope", scope)
              .get(as(actor).toEndpoint(SEARCH_ACCOUNTS_USING_GET));
        });
  }
    ...
    return Task.where(
        ...
        actor -> {
          rest()
              ...
              .pathParam("id", id)
              .body(body)
              .patch(as(actor).toEndpoint(PATCH_DISQUALIFICATION_REASON_USING_PATCH));
        });
  }
    ...
    return Task.where(
        ...
        actor -> {
          rest()
              ...
              .contentType("application/json")
              .pathParam("id", id)
              .get(as(actor).toEndpoint(GET_DISQUALIFICATION_REASON_BY_ID_USING_GET));
        });
  }
    ...
    return Task.where(
        ...
        actor -> {
          rest()
              ...
              .contentType("application/json")
              .pathParam("id", id)
              .delete(as(actor).toEndpoint(DELETE_DISQUALIFICATION_REASON_USING_DELETE));
        });
  }
    ...
    return Task.where(
        ...
        actor -> {
          rest()
              ...
              .pathParam("id", id)
              .body(body)
              .put(as(actor).toEndpoint(UPDATE_DISQUALIFICATION_REASON_USING_PUT));
        });
  }
    ...
    return Task.where(
        ...
        actor -> {
          rest()
              ...
              .contentType("application/json")
              .pathParam("id", id)
              .delete(as(actor).toEndpoint(DELETE_RELATED_ACCOUNT_USING_DELETE));
        });
  }
    ...
    return Task.where(
        ...
        actor -> {
          rest()
              ...
              .body(body)
              .pathParam("accountId", accountId)
              .post(as(actor).toEndpoint(CREATE_CONTACT_USING_POST));
        });
  }
    ...
    return Task.where(
        ...
        actor -> {
          rest()
              ...
              .pathParam("accountId", accountId)
              .body(body)
              .post(as(actor).toEndpoint(CREATE_LOCATION_USING_POST));
        });
  }
    ...
    return Task.where(
        ...
        actor -> {
          rest()
              ...
              .pathParam("id", id)
              .body(body)
              .patch(as(actor).toEndpoint(PATCH_SERVICE_TEAM_MEMBER_USING_PATCH));
        });
  }
    ...
    return Task.where(
        ...
        actor -> {
          rest()
              ...
              .contentType("application/json")
              .pathParam("id", id)
              .get(as(actor).toEndpoint(GET_SERVICE_TEAM_MEMBER_USING_GET));
        });
  }
    ...
    return Task.where(
        ...
        actor -> {
          rest()
              ...
              .contentType("application/json")
              .pathParam("id", id)
              .delete(as(actor).toEndpoint(DELETE_SERVICE_TEAM_MEMBER_USING_DELETE));
        });
  }
    ...
    return Task.where(
        ...
        actor -> {
          rest()
              ...
              .pathParam("id", id)
              .body(body)
              .put(as(actor).toEndpoint(UPDATE_SERVICE_TEAM_MEMBER_USING_PUT));
        });
  }
    ...
    return Task.where(
        ...
        actor -> {
          rest()
              ...
              .pathParam("id", id)
              .body(body)
              .patch(as(actor).toEndpoint(PATCH_LOCATION_USING_PATCH));
        });
  }
    ...
    return Task.where(
        ...
        actor -> {
          rest()
              ...
              .contentType("application/json")
              .pathParam("id", id)
              .get(as(actor).toEndpoint(GET_LOCATION_USING_GET));
        });
  }
    ...
    return Task.where(
        ...
        actor -> {
          rest()
              ...
              .contentType("application/json")
              .pathParam("id", id)
              .delete(as(actor).toEndpoint(DELETE_LOCATION_USING_DELETE));
        });
  }
    ...
    return Task.where(
        ...
        actor -> {
          rest()
              ...
              .pathParam("id", id)
              .body(body)
              .put(as(actor).toEndpoint(UPDATE_LOCATION_USING_PUT));
        });
  }

  public static Performable getCustomersByIdsUsingGet(
      String pageSize, String page, String ids, String filter, String scope) {
    return Task.where(
        ...
        actor -> {
          rest()
              ...
              .queryParam("filter", filter)
              .queryParam("scope", scope)
              .get(as(actor).toEndpoint(GET_CUSTOMERS_BY_IDS_USING_GET));
        });
  }

  public static Performable getLeadsUsingGet(
      String pageSize,
      String page,
      String isDisqualified,
      String searchTerm,
    ...
    return Task.where(
        ...
        actor -> {
          rest()
              ...
              .queryParam("sortField", sortField)
              .queryParam("ids", ids)
              .get(as(actor).toEndpoint(GET_LEADS_USING_GET));
        });
  }
    ...
    return Task.where(
        ...
        actor -> {
          rest()
              ...
              .post(as(actor).toEndpoint(CONVERT_LEAD_ACCOUNT_TO_PROSPECT_USING_POST));
        });
  }
    ...
    return Task.where(
        ...
        actor -> {
          rest()
              ...
              .pathParam("id", id)
              .body(body)
              .patch(as(actor).toEndpoint(PATCH_LEAD_SOURCE_USING_PATCH));
        });
  }
    ...
    return Task.where(
        ...
        actor -> {
          rest()
              ...
              .contentType("application/json")
              .pathParam("id", id)
              .get(as(actor).toEndpoint(GET_LEAD_SOURCE_BY_ID_USING_GET));
        });
  }
    ...
    return Task.where(
        ...
        actor -> {
          rest()
              ...
              .contentType("application/json")
              .pathParam("id", id)
              .delete(as(actor).toEndpoint(DELETE_LEAD_SOURCE_USING_DELETE));
        });
  }
    ...
    return Task.where(
        ...
        actor -> {
          rest()
              ...
              .pathParam("id", id)
              .body(body)
              .put(as(actor).toEndpoint(UPDATE_LEAD_SOURCE_USING_PUT));
        });
  }
    ...
    return Task.where(
        ...
        actor -> {
          rest()
              ...
              .contentType("application/json")
              .body(body)
              .post(as(actor).toEndpoint(CREATE_CUSTOMER_USING_POST));
        });
  }
    ...
    return Task.where(
        ...
        actor -> {
          rest()
              ...
              .contentType("application/json")
              .body(body)
              .post(as(actor).toEndpoint(CREATE_LEAD_SOURCE_USING_POST));
        });
  }

  public static Performable getRelatedAccountsUsingGet(
      String accountId, String pageSize, String page) {
    return Task.where(
        ...
        actor -> {
          rest()
              ...
              .queryParam("pageSize", pageSize)
              .queryParam("page", page)
              .get(as(actor).toEndpoint(GET_RELATED_ACCOUNTS_USING_GET));
        });
  }
    ...
    return Task.where(
        ...
        actor -> {
          rest()
              ...
              .pathParam("leadId", leadId)
              .body(body)
              .post(as(actor).toEndpoint(CREATE_DISQUALIFICATION_USING_POST));
        });
  }
    ...
    return Task.where(
        ...
        actor -> {
          rest()
              ...
              .contentType("application/json")
              .pathParam("leadId", leadId)
              .delete(as(actor).toEndpoint(DELETE_DISQUALIFICATION_ON_LEAD_USING_DELETE));
        });
  }
    ...
    return Task.where(
        ...
        actor -> {
          rest()
              ...
              .pathParam("leadId", leadId)
              .body(body)
              .put(as(actor).toEndpoint(UPDATE_DISQUALIFICATION_ON_LEAD_USING_PUT));
        });
  }
}
