...
public class UseCustomerServiceTo {
  ...
  private static final String GET_LEAD_SOURCES_BY_CONTEXT_USING_GET_ON_THE_LEAD_SOURCE_CONTROLLER =
      "lead-sources";
  private static final String
      GET_DISQUALIFICATION_REASONS_BY_CONTEXT_USING_GET_ON_THE_DISQUALIFICATION_REASON_CONTROLLER =
          "disqualification-reasons";
  private static final String CREATE_ACCOUNT_USING_POST_ON_THE_ACCOUNT_CONTROLLER = "accounts";
  private static final String
      CREATE_SERVICE_TEAM_MEMBER_USING_POST_ON_THE_SERVICE_TEAM_MEMBER_CONTROLLER =
          "accounts/{accountId}/service-team-members";
  private static final String PATCH_CUSTOMER_USING_PATCH_ON_THE_CUSTOMER_CONTROLLER =
      "customers/{customerId}";
  private static final String GET_CUSTOMER_USING_GET_ON_THE_CUSTOMER_CONTROLLER =
      "customers/{customerId}";
  private static final String DELETE_CUSTOMER_USING_DELETE_ON_THE_CUSTOMER_CONTROLLER =
      "customers/{customerId}";
  private static final String UPDATE_CUSTOMER_USING_PUT_ON_THE_CUSTOMER_CONTROLLER =
      "customers/{customerId}";
  ...
  private static final String GET_LOCATIONS_PER_ACCOUNT_USING_GET_ON_THE_LOCATION_CONTROLLER =
      "accounts/{accountId}/locations";
  private static final String CONVERT_LEAD_USING_POST_ON_THE_CUSTOMER_CONTROLLER = "customers";
  private static final String GET_LEADS_BY_IDS_USING_GET_ON_THE_LEAD_CONTROLLER =
      "leads?filter=byIds&scope=descendants";
  private static final String GET_CONTACTS_FOR_ACCOUNT_BY_ID_USING_GET_ON_THE_CONTACT_CONTROLLER =
      "accounts/{accountId}/contacts";
  private static final String
      CREATE_DISQUALIFICATION_REASON_USING_POST_ON_THE_DISQUALIFICATION_REASON_CONTROLLER =
          "disqualification-reasons";
  private static final String CREATE_LEAD_USING_POST_ON_THE_LEAD_CONTROLLER = "leads";
  private static final String
      GET_SERVICE_TEAM_MEMBERS_PER_ACCOUNT_USING_GET_ON_THE_SERVICE_TEAM_MEMBER_CONTROLLER =
          "accounts/{accountId}/service-team-members";
  private static final String PATCH_ACCOUNT_USING_PATCH_ON_THE_ACCOUNT_CONTROLLER = "accounts/{id}";
  private static final String GET_ACCOUNT_BY_ID_USING_GET_ON_THE_ACCOUNT_CONTROLLER =
      "accounts/{id}";
  private static final String DELETE_ACCOUNT_USING_DELETE_ON_THE_ACCOUNT_CONTROLLER =
      "accounts/{id}";
  private static final String UPDATE_ACCOUNT_USING_PUT_ON_THE_ACCOUNT_CONTROLLER = "accounts/{id}";
  private static final String GET_ACCOUNTS_BY_IDS_USING_GET_ON_THE_ACCOUNT_CONTROLLER =
      "accounts?filter=byIds&scope=descendants";
  private static final String GET_CUSTOMERS_BY_SEARCH_TERM_USING_GET_ON_THE_CUSTOMER_CONTROLLER =
      "customers?filter=bySearchTerm&scope=descendants";
  ...
  private static final String DELETE_CONTACT_USING_DELETE_ON_THE_CONTACT_CONTROLLER =
      "contacts/{id}";
  private static final String UPDATE_CONTACT_USING_PUT_ON_THE_CONTACT_CONTROLLER = "contacts/{id}";
  private static final String SEARCH_LEADS_USING_GET_ON_THE_LEAD_CONTROLLER =
      "leads?filter=bySearchTerm&scope=descendants";
  private static final String CREATE_RELATED_ACCOUNT_USING_POST_ON_THE_RELATED_ACCOUNT_CONTROLLER =
      "accounts/{accountId}/related-accounts";
  private static final String SEARCH_ACCOUNTS_USING_GET_ON_THE_ACCOUNT_CONTROLLER =
      "accounts?filter=bySearchTerm&scope=descendants";
  private static final String
      PATCH_DISQUALIFICATION_REASON_USING_PATCH_ON_THE_DISQUALIFICATION_REASON_CONTROLLER =
          "disqualification-reasons/{id}";
  private static final String
      GET_DISQUALIFICATION_REASON_BY_ID_USING_GET_ON_THE_DISQUALIFICATION_REASON_CONTROLLER =
          "disqualification-reasons/{id}";
  private static final String
      DELETE_DISQUALIFICATION_REASON_USING_DELETE_ON_THE_DISQUALIFICATION_REASON_CONTROLLER =
          "disqualification-reasons/{id}";
  private static final String
      UPDATE_DISQUALIFICATION_REASON_USING_PUT_ON_THE_DISQUALIFICATION_REASON_CONTROLLER =
          "disqualification-reasons/{id}";
  private static final String
      DELETE_RELATED_ACCOUNT_USING_DELETE_ON_THE_RELATED_ACCOUNT_CONTROLLER =
          "related-accounts/{id}";
  private static final String CREATE_CONTACT_USING_POST_ON_THE_CONTACT_CONTROLLER =
      "accounts/{accountId}/contacts";
  private static final String CREATE_LOCATION_USING_POST_ON_THE_LOCATION_CONTROLLER =
      "accounts/{accountId}/locations";
  private static final String
      PATCH_SERVICE_TEAM_MEMBER_USING_PATCH_ON_THE_SERVICE_TEAM_MEMBER_CONTROLLER =
          "service-team-members/{id}";
  private static final String
      GET_SERVICE_TEAM_MEMBER_USING_GET_ON_THE_SERVICE_TEAM_MEMBER_CONTROLLER =
          "service-team-members/{id}";
  private static final String
      DELETE_SERVICE_TEAM_MEMBER_USING_DELETE_ON_THE_SERVICE_TEAM_MEMBER_CONTROLLER =
          "service-team-members/{id}";
  private static final String
      UPDATE_SERVICE_TEAM_MEMBER_USING_PUT_ON_THE_SERVICE_TEAM_MEMBER_CONTROLLER =
          "service-team-members/{id}";
  private static final String PATCH_LOCATION_USING_PATCH_ON_THE_LOCATION_CONTROLLER =
      "locations/{id}";
  private static final String GET_LOCATION_USING_GET_ON_THE_LOCATION_CONTROLLER = "locations/{id}";
  private static final String DELETE_LOCATION_USING_DELETE_ON_THE_LOCATION_CONTROLLER =
      "locations/{id}";
  private static final String UPDATE_LOCATION_USING_PUT_ON_THE_LOCATION_CONTROLLER =
      "locations/{id}";
  private static final String GET_CUSTOMERS_BY_IDS_USING_GET_ON_THE_CUSTOMER_CONTROLLER =
      "customers?filter=byIds&scope=descendants";
  private static final String GET_LEADS_USING_GET_ON_THE_LEAD_CONTROLLER = "leads";
  private static final String
      CONVERT_LEAD_ACCOUNT_TO_PROSPECT_USING_POST_ON_THE_ACCOUNT_CONTROLLER = "accounts";
  private static final String PATCH_LEAD_SOURCE_USING_PATCH_ON_THE_LEAD_SOURCE_CONTROLLER =
      "lead-sources/{id}";
  private static final String GET_LEAD_SOURCE_BY_ID_USING_GET_ON_THE_LEAD_SOURCE_CONTROLLER =
      "lead-sources/{id}";
  private static final String DELETE_LEAD_SOURCE_USING_DELETE_ON_THE_LEAD_SOURCE_CONTROLLER =
      "lead-sources/{id}";
  private static final String UPDATE_LEAD_SOURCE_USING_PUT_ON_THE_LEAD_SOURCE_CONTROLLER =
      "lead-sources/{id}";
  private static final String CREATE_CUSTOMER_USING_POST_ON_THE_CUSTOMER_CONTROLLER = "customers";
  private static final String CREATE_LEAD_SOURCE_USING_POST_ON_THE_LEAD_SOURCE_CONTROLLER =
      "lead-sources";
  private static final String GET_RELATED_ACCOUNTS_USING_GET_ON_THE_RELATED_ACCOUNT_CONTROLLER =
      "accounts/{accountId}/related-accounts";
  private static final String
      CREATE_DISQUALIFICATION_USING_POST_ON_THE_DISQUALIFICATION_CONTROLLER =
          "leads/{leadId}/disqualification";
  private static final String
      DELETE_DISQUALIFICATION_ON_LEAD_USING_DELETE_ON_THE_DISQUALIFICATION_CONTROLLER =
          "leads/{leadId}/disqualification";
  private static final String
      UPDATE_DISQUALIFICATION_ON_LEAD_USING_PUT_ON_THE_DISQUALIFICATION_CONTROLLER =
          "leads/{leadId}/disqualification";
    ...
    return Task.where(
        ...
        actor -> {
          CallTitanApi.asActorUsingService(actor, THIS_SERVICE)
              ...
              .get(GET_LEAD_SOURCES_BY_CONTEXT_USING_GET_ON_THE_LEAD_SOURCE_CONTROLLER);
        });
  }
    ...
    return Task.where(
        ...
        actor -> {
          CallTitanApi.asActorUsingService(actor, THIS_SERVICE)
              .contentType("application/json")
              .body(body)
              .post(CREATE_ACCOUNT_USING_POST_ON_THE_ACCOUNT_CONTROLLER);
        });
  }
    ...
    return Task.where(
        ...
        actor -> {
          CallTitanApi.asActorUsingService(actor, THIS_SERVICE)
              ...
              .body(body)
              .post(CREATE_SERVICE_TEAM_MEMBER_USING_POST_ON_THE_SERVICE_TEAM_MEMBER_CONTROLLER);
        });
  }
    ...
    return Task.where(
        ...
        actor -> {
          CallTitanApi.asActorUsingService(actor, THIS_SERVICE)
              ...
              .patch(PATCH_CUSTOMER_USING_PATCH_ON_THE_CUSTOMER_CONTROLLER);
        });
  }
    ...
    return Task.where(
        ...
        actor -> {
          CallTitanApi.asActorUsingService(actor, THIS_SERVICE)
              .contentType("application/json")
              .pathParam("customerId", customerId)
              .get(GET_CUSTOMER_USING_GET_ON_THE_CUSTOMER_CONTROLLER);
        });
  }
    ...
    return Task.where(
        ...
        actor -> {
          CallTitanApi.asActorUsingService(actor, THIS_SERVICE)
              .contentType("application/json")
              .pathParam("customerId", customerId)
              .delete(DELETE_CUSTOMER_USING_DELETE_ON_THE_CUSTOMER_CONTROLLER);
        });
  }
    ...
    return Task.where(
        ...
        actor -> {
          CallTitanApi.asActorUsingService(actor, THIS_SERVICE)
              ...
              .body(body)
              .pathParam("customerId", customerId)
              .put(UPDATE_CUSTOMER_USING_PUT_ON_THE_CUSTOMER_CONTROLLER);
        });
  }
    ...
    return Task.where(
        ...
        actor -> {
          CallTitanApi.asActorUsingService(actor, THIS_SERVICE)
              ...
              .patch(PATCH_LEAD_USING_PATCH_ON_THE_LEAD_CONTROLLER);
        });
  }
    ...
    return Task.where(
        ...
        actor -> {
          CallTitanApi.asActorUsingService(actor, THIS_SERVICE)
              .contentType("application/json")
              .pathParam("leadId", leadId)
              .get(GET_LEAD_USING_GET_ON_THE_LEAD_CONTROLLER);
        });
  }
    ...
    return Task.where(
        ...
        actor -> {
          CallTitanApi.asActorUsingService(actor, THIS_SERVICE)
              .contentType("application/json")
              .pathParam("leadId", leadId)
              .delete(DELETE_LEAD_USING_DELETE_ON_THE_LEAD_CONTROLLER);
        });
  }
    ...
    return Task.where(
        ...
        actor -> {
          CallTitanApi.asActorUsingService(actor, THIS_SERVICE)
              ...
              .body(body)
              .pathParam("leadId", leadId)
              .put(UPDATE_LEAD_USING_PUT_ON_THE_LEAD_CONTROLLER);
        });
  }
    ...
    return Task.where(
        ...
        actor -> {
          CallTitanApi.asActorUsingService(actor, THIS_SERVICE)
              ...
              .queryParam("pageSize", pageSize)
              .queryParam("page", page)
              .get(GET_LOCATIONS_PER_ACCOUNT_USING_GET_ON_THE_LOCATION_CONTROLLER);
        });
  }
    ...
    return Task.where(
        ...
        actor -> {
          CallTitanApi.asActorUsingService(actor, THIS_SERVICE)
              ...
              .post(CONVERT_LEAD_USING_POST_ON_THE_CUSTOMER_CONTROLLER);
        });
  }
    ...
    return Task.where(
        ...
        actor -> {
          CallTitanApi.asActorUsingService(actor, THIS_SERVICE)
              ...
              .get(GET_LEADS_BY_IDS_USING_GET_ON_THE_LEAD_CONTROLLER);
        });
  }
    ...
    return Task.where(
        ...
        actor -> {
          CallTitanApi.asActorUsingService(actor, THIS_SERVICE)
              ...
              .queryParam("page", page)
              .pathParam("accountId", accountId)
              .get(GET_CONTACTS_FOR_ACCOUNT_BY_ID_USING_GET_ON_THE_CONTACT_CONTROLLER);
        });
  }
    ...
    return Task.where(
        ...
        actor -> {
          CallTitanApi.asActorUsingService(actor, THIS_SERVICE)
              .contentType("application/json")
              .body(body)
              .post(CREATE_LEAD_USING_POST_ON_THE_LEAD_CONTROLLER);
        });
  }
    ...
    return Task.where(
        ...
        actor -> {
          CallTitanApi.asActorUsingService(actor, THIS_SERVICE)
              ...
              .body(body)
              .pathParam("id", id)
              .patch(PATCH_ACCOUNT_USING_PATCH_ON_THE_ACCOUNT_CONTROLLER);
        });
  }
    ...
    return Task.where(
        ...
        actor -> {
          CallTitanApi.asActorUsingService(actor, THIS_SERVICE)
              .contentType("application/json")
              .pathParam("id", id)
              .get(GET_ACCOUNT_BY_ID_USING_GET_ON_THE_ACCOUNT_CONTROLLER);
        });
  }
    ...
    return Task.where(
        ...
        actor -> {
          CallTitanApi.asActorUsingService(actor, THIS_SERVICE)
              .contentType("application/json")
              .pathParam("id", id)
              .delete(DELETE_ACCOUNT_USING_DELETE_ON_THE_ACCOUNT_CONTROLLER);
        });
  }
    ...
    return Task.where(
        ...
        actor -> {
          CallTitanApi.asActorUsingService(actor, THIS_SERVICE)
              ...
              .body(body)
              .pathParam("id", id)
              .put(UPDATE_ACCOUNT_USING_PUT_ON_THE_ACCOUNT_CONTROLLER);
        });
  }
    ...
    return Task.where(
        ...
        actor -> {
          CallTitanApi.asActorUsingService(actor, THIS_SERVICE)
              ...
              .queryParam("filter", filter)
              .queryParam("scope", scope)
              .get(GET_ACCOUNTS_BY_IDS_USING_GET_ON_THE_ACCOUNT_CONTROLLER);
        });
  }
    ...
    return Task.where(
        ...
        actor -> {
          CallTitanApi.asActorUsingService(actor, THIS_SERVICE)
              ...
              .queryParam("filter", filter)
              .queryParam("scope", scope)
              .get(GET_CUSTOMERS_BY_SEARCH_TERM_USING_GET_ON_THE_CUSTOMER_CONTROLLER);
        });
  }
    ...
    return Task.where(
        ...
        actor -> {
          CallTitanApi.asActorUsingService(actor, THIS_SERVICE)
              ...
              .body(body)
              .pathParam("id", id)
              .patch(PATCH_CONTACT_USING_PATCH_ON_THE_CONTACT_CONTROLLER);
        });
  }
    ...
    return Task.where(
        ...
        actor -> {
          CallTitanApi.asActorUsingService(actor, THIS_SERVICE)
              .contentType("application/json")
              .pathParam("id", id)
              .get(GET_CONTACT_USING_GET_ON_THE_CONTACT_CONTROLLER);
        });
  }
    ...
    return Task.where(
        ...
        actor -> {
          CallTitanApi.asActorUsingService(actor, THIS_SERVICE)
              .contentType("application/json")
              .pathParam("id", id)
              .delete(DELETE_CONTACT_USING_DELETE_ON_THE_CONTACT_CONTROLLER);
        });
  }
    ...
    return Task.where(
        ...
        actor -> {
          CallTitanApi.asActorUsingService(actor, THIS_SERVICE)
              ...
              .body(body)
              .pathParam("id", id)
              .put(UPDATE_CONTACT_USING_PUT_ON_THE_CONTACT_CONTROLLER);
        });
  }
    ...
    return Task.where(
        ...
        actor -> {
          CallTitanApi.asActorUsingService(actor, THIS_SERVICE)
              ...
              .queryParam("filter", filter)
              .queryParam("scope", scope)
              .get(SEARCH_LEADS_USING_GET_ON_THE_LEAD_CONTROLLER);
        });
  }
    ...
    return Task.where(
        ...
        actor -> {
          CallTitanApi.asActorUsingService(actor, THIS_SERVICE)
              ...
              .body(body)
              .pathParam("accountId", accountId)
              .post(CREATE_RELATED_ACCOUNT_USING_POST_ON_THE_RELATED_ACCOUNT_CONTROLLER);
        });
  }
    ...
    return Task.where(
        ...
        actor -> {
          CallTitanApi.asActorUsingService(actor, THIS_SERVICE)
              ...
              .queryParam("filter", filter)
              .queryParam("scope", scope)
              .get(SEARCH_ACCOUNTS_USING_GET_ON_THE_ACCOUNT_CONTROLLER);
        });
  }
    ...
    return Task.where(
        ...
        actor -> {
          CallTitanApi.asActorUsingService(actor, THIS_SERVICE)
              .contentType("application/json")
              .pathParam("id", id)
              .delete(DELETE_RELATED_ACCOUNT_USING_DELETE_ON_THE_RELATED_ACCOUNT_CONTROLLER);
        });
  }
    ...
    return Task.where(
        ...
        actor -> {
          CallTitanApi.asActorUsingService(actor, THIS_SERVICE)
              ...
              .body(body)
              .pathParam("accountId", accountId)
              .post(CREATE_CONTACT_USING_POST_ON_THE_CONTACT_CONTROLLER);
        });
  }
    ...
    return Task.where(
        ...
        actor -> {
          CallTitanApi.asActorUsingService(actor, THIS_SERVICE)
              ...
              .pathParam("accountId", accountId)
              .body(body)
              .post(CREATE_LOCATION_USING_POST_ON_THE_LOCATION_CONTROLLER);
        });
  }
    ...
    return Task.where(
        ...
        actor -> {
          CallTitanApi.asActorUsingService(actor, THIS_SERVICE)
              ...
              .pathParam("id", id)
              .body(body)
              .patch(PATCH_SERVICE_TEAM_MEMBER_USING_PATCH_ON_THE_SERVICE_TEAM_MEMBER_CONTROLLER);
        });
  }
    ...
    return Task.where(
        ...
        actor -> {
          CallTitanApi.asActorUsingService(actor, THIS_SERVICE)
              .contentType("application/json")
              .pathParam("id", id)
              .get(GET_SERVICE_TEAM_MEMBER_USING_GET_ON_THE_SERVICE_TEAM_MEMBER_CONTROLLER);
        });
  }
    ...
    return Task.where(
        ...
        actor -> {
          CallTitanApi.asActorUsingService(actor, THIS_SERVICE)
              ...
              .pathParam("id", id)
              .body(body)
              .put(UPDATE_SERVICE_TEAM_MEMBER_USING_PUT_ON_THE_SERVICE_TEAM_MEMBER_CONTROLLER);
        });
  }
    ...
    return Task.where(
        ...
        actor -> {
          CallTitanApi.asActorUsingService(actor, THIS_SERVICE)
              ...
              .pathParam("id", id)
              .body(body)
              .patch(PATCH_LOCATION_USING_PATCH_ON_THE_LOCATION_CONTROLLER);
        });
  }
    ...
    return Task.where(
        ...
        actor -> {
          CallTitanApi.asActorUsingService(actor, THIS_SERVICE)
              .contentType("application/json")
              .pathParam("id", id)
              .get(GET_LOCATION_USING_GET_ON_THE_LOCATION_CONTROLLER);
        });
  }
    ...
    return Task.where(
        ...
        actor -> {
          CallTitanApi.asActorUsingService(actor, THIS_SERVICE)
              .contentType("application/json")
              .pathParam("id", id)
              .delete(DELETE_LOCATION_USING_DELETE_ON_THE_LOCATION_CONTROLLER);
        });
  }
    ...
    return Task.where(
        ...
        actor -> {
          CallTitanApi.asActorUsingService(actor, THIS_SERVICE)
              ...
              .pathParam("id", id)
              .body(body)
              .put(UPDATE_LOCATION_USING_PUT_ON_THE_LOCATION_CONTROLLER);
        });
  }
    ...
    return Task.where(
        ...
        actor -> {
          CallTitanApi.asActorUsingService(actor, THIS_SERVICE)
              ...
              .queryParam("filter", filter)
              .queryParam("scope", scope)
              .get(GET_CUSTOMERS_BY_IDS_USING_GET_ON_THE_CUSTOMER_CONTROLLER);
        });
  }
    ...
    return Task.where(
        ...
        actor -> {
          CallTitanApi.asActorUsingService(actor, THIS_SERVICE)
              ...
              .queryParam("sortField", sortField)
              .queryParam("ids", ids)
              .get(GET_LEADS_USING_GET_ON_THE_LEAD_CONTROLLER);
        });
  }
    ...
    return Task.where(
        ...
        actor -> {
          CallTitanApi.asActorUsingService(actor, THIS_SERVICE)
              ...
              .post(CONVERT_LEAD_ACCOUNT_TO_PROSPECT_USING_POST_ON_THE_ACCOUNT_CONTROLLER);
        });
  }
    ...
    return Task.where(
        ...
        actor -> {
          CallTitanApi.asActorUsingService(actor, THIS_SERVICE)
              ...
              .pathParam("id", id)
              .body(body)
              .patch(PATCH_LEAD_SOURCE_USING_PATCH_ON_THE_LEAD_SOURCE_CONTROLLER);
        });
  }
    ...
    return Task.where(
        ...
        actor -> {
          CallTitanApi.asActorUsingService(actor, THIS_SERVICE)
              .contentType("application/json")
              .pathParam("id", id)
              .get(GET_LEAD_SOURCE_BY_ID_USING_GET_ON_THE_LEAD_SOURCE_CONTROLLER);
        });
  }
    ...
    return Task.where(
        ...
        actor -> {
          CallTitanApi.asActorUsingService(actor, THIS_SERVICE)
              .contentType("application/json")
              .pathParam("id", id)
              .delete(DELETE_LEAD_SOURCE_USING_DELETE_ON_THE_LEAD_SOURCE_CONTROLLER);
        });
  }
    ...
    return Task.where(
        ...
        actor -> {
          CallTitanApi.asActorUsingService(actor, THIS_SERVICE)
              ...
              .pathParam("id", id)
              .body(body)
              .put(UPDATE_LEAD_SOURCE_USING_PUT_ON_THE_LEAD_SOURCE_CONTROLLER);
        });
  }
    ...
    return Task.where(
        ...
        actor -> {
          CallTitanApi.asActorUsingService(actor, THIS_SERVICE)
              .contentType("application/json")
              .body(body)
              .post(CREATE_CUSTOMER_USING_POST_ON_THE_CUSTOMER_CONTROLLER);
        });
  }
    ...
    return Task.where(
        ...
        actor -> {
          CallTitanApi.asActorUsingService(actor, THIS_SERVICE)
              .contentType("application/json")
              .body(body)
              .post(CREATE_LEAD_SOURCE_USING_POST_ON_THE_LEAD_SOURCE_CONTROLLER);
        });
  }
    ...
    return Task.where(
        ...
        actor -> {
          CallTitanApi.asActorUsingService(actor, THIS_SERVICE)
              ...
              .queryParam("pageSize", pageSize)
              .queryParam("page", page)
              .get(GET_RELATED_ACCOUNTS_USING_GET_ON_THE_RELATED_ACCOUNT_CONTROLLER);
        });
  }
    ...
    return Task.where(
        ...
        actor -> {
          CallTitanApi.asActorUsingService(actor, THIS_SERVICE)
              ...
              .pathParam("leadId", leadId)
              .body(body)
              .post(CREATE_DISQUALIFICATION_USING_POST_ON_THE_DISQUALIFICATION_CONTROLLER);
        });
  }
    ...
    return Task.where(
        ...
        actor -> {
          CallTitanApi.asActorUsingService(actor, THIS_SERVICE)
              ...
              .pathParam("leadId", leadId)
              .body(body)
              .put(UPDATE_DISQUALIFICATION_ON_LEAD_USING_PUT_ON_THE_DISQUALIFICATION_CONTROLLER);
        });
  }
}
