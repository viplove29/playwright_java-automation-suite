...
public class UseNotificationServiceTo {
	...
	public static Performable deleteEmailAddressUsingDeleteOnTheUserPreferencesController(String id){
		...
		"{0} Delete email address", 
			actor -> {
				CallTitanApi.asActorUsingService(actor, THIS_SERVICE).contentType("application/json").pathParam("id", id).delete("email-addresses/{id}");
			}
		);
	}
	...
	public static Performable patchMessageUsingPatchOnTheEmailMessageController(String id, Object body){
		...
		"{0} Update a EmailMessage identified by the provided id", 
			actor -> {
				CallTitanApi.asActorUsingService(actor, THIS_SERVICE).contentType("application/json").pathParam("id", id).body(body).patch("email-messages/{id}");
			}
		);
	}
	...
	public static Performable getEmailAddressUsingGetOnTheUserPreferencesController(String id){
		...
		"{0} Get an email address", 
			actor -> {
				CallTitanApi.asActorUsingService(actor, THIS_SERVICE).contentType("application/json").pathParam("id", id).get("email-addresses/{id}");
			}
		);
	}
	...
	public static Performable getEmailStatusUsingGetOnTheEmailController(String id){
		...
		"{0} Get email status", 
			actor -> {
				CallTitanApi.asActorUsingService(actor, THIS_SERVICE).contentType("application/json").pathParam("id", id).get("emails/{id}");
			}
		);
	}
	...
	public static Performable validateVerificationCodeUsingPutOnTheUserPreferencesController(String id, Object body){
		...
		"{0} Validate verification code for email address", 
			actor -> {
				CallTitanApi.asActorUsingService(actor, THIS_SERVICE).contentType("application/json").pathParam("id", id).body(body).put("email-addresses/{id}/verification-code");
			}
		);
	}
	...
	public static Performable findAllEmailAddressesUsingGetOnTheUserPreferencesController(String pageSize, String page){
		...
		"{0} Get all email addresses", 
			actor -> {
				CallTitanApi.asActorUsingService(actor, THIS_SERVICE).contentType("application/json").queryParam("pageSize", pageSize).queryParam("page", page).get("email-addresses");
			}
		);
	}
	...
	public static Performable generateVerificationCodeAndEmailUsingPostOnTheUserPreferencesController(String id){
		...
		"{0} Generate verification code for email address", 
			actor -> {
				CallTitanApi.asActorUsingService(actor, THIS_SERVICE).contentType("application/json").pathParam("id", id).post("email-addresses/{id}/verification-code");
			}
		);
	}
	...
	public static Performable syncEmailFoldersUsingPostOnTheEmailMessageController(){
		...
		"{0} Sync email folder by folderId", 
			actor -> {
				CallTitanApi.asActorUsingService(actor, THIS_SERVICE).contentType("application/json").post("sync-folder/sync");
			}
		);
	}
	...
	public static Performable getFoldersUsingGetOnTheEmailMessageController(){
		...
		"{0} Get User's Primary Email Folders", 
			actor -> {
				CallTitanApi.asActorUsingService(actor, THIS_SERVICE).contentType("application/json").get("email-folders");
			}
		);
	}
	...
	public static Performable getAllChannelsUsingGetOnTheChannelController(String includeInactive, String pageSize, String page){
		...
		"{0} Get all channels", 
			actor -> {
				CallTitanApi.asActorUsingService(actor, THIS_SERVICE).contentType("application/json").queryParam("includeInactive", includeInactive).queryParam("pageSize", pageSize).queryParam("page", page).get("channels");
			}
		);
	}
	...
	public static Performable selectSyncFolderUsingPutOnTheEmailMessageController(Object body){
		...
		"{0} Upsert User's selected Folder for their Primary Email to be used by Mailroom", 
			actor -> {
				CallTitanApi.asActorUsingService(actor, THIS_SERVICE).contentType("application/json").body(body).put("sync-folder");
			}
		);
	}
	...
	public static Performable deleteMessageByIdUsingDeleteOnTheEmailMessageController(String id){
		...
		"{0} Delete a Message identified by the provided id", 
			actor -> {
				CallTitanApi.asActorUsingService(actor, THIS_SERVICE).contentType("application/json").pathParam("id", id).delete("email-messages/{id}");
			}
		);
	}
	...
	public static Performable createEmailAddressUsingPostOnTheUserPreferencesController(Object body){
		...
		"{0} Create an email address", 
			actor -> {
				CallTitanApi.asActorUsingService(actor, THIS_SERVICE).contentType("application/json").body(body).post("email-addresses");
			}
		);
	}
	...
	public static Performable findAllVerifiedAndActiveEmailAddressesUsingGetOnTheUserPreferencesController(String pageSize, String page){
		...
		"{0} Get all verified and active email addresses", 
			actor -> {
				CallTitanApi.asActorUsingService(actor, THIS_SERVICE).contentType("application/json").queryParam("pageSize", pageSize).queryParam("page", page).get("email-addresses/active");
			}
		);
	}
	...
	public static Performable getSelectedSyncFolderUsingGetOnTheEmailMessageController(){
		...
		"{0} Get User's Sync Folder for their Primary Email", 
			actor -> {
				CallTitanApi.asActorUsingService(actor, THIS_SERVICE).contentType("application/json").get("sync-folder");
			}
		);
	}
	...
	public static Performable processCallbackWithContextUsingPostOnTheOAuthController(String provider, String code, String state){
		...
		"{0} Process OAuth Callback", 
			actor -> {
				CallTitanApi.asActorUsingService(actor, THIS_SERVICE).contentType("application/json").pathParam("provider", provider).queryParam("code", code).queryParam("state", state).post("oauth/{provider}/callback");
			}
		);
	}
	...
	public static Performable updateEmailAddressUsingPutOnTheUserPreferencesController(String id, Object body){
		...
		"{0} Replace email address", 
			actor -> {
				CallTitanApi.asActorUsingService(actor, THIS_SERVICE).contentType("application/json").pathParam("id", id).body(body).put("email-addresses/{id}");
			}
		);
	}
	...
	public static Performable cancelEmailSendUsingDeleteOnTheEmailController(String id){
		...
		"{0} Cancel Email Send", 
			actor -> {
				CallTitanApi.asActorUsingService(actor, THIS_SERVICE).contentType("application/json").pathParam("id", id).delete("emails/{id}");
			}
		);
	}
	...
	public static Performable refreshTokenUsingPutOnTheOAuthController(String provider, String baseEmailAddressId){
		...
		"{0} Refresh OAuth Token", 
			actor -> {
				CallTitanApi.asActorUsingService(actor, THIS_SERVICE).contentType("application/json").pathParam("provider", provider).queryParam("baseEmailAddressId", baseEmailAddressId).put("oauth/{provider}/token/refresh");
			}
		);
	}
	...
	public static Performable testAccountProvisioningOnTheEmailRelayAccountController(){
		...
		"{0} Test account provisioning", 
			actor -> {
				CallTitanApi.asActorUsingService(actor, THIS_SERVICE).contentType("application/json").get("provision-sendgrid-accounts");
			}
		);
	}
	...
	public static Performable getChannelUsingGetOnTheChannelController(String id){
		...
		"{0} Get a channel", 
			actor -> {
				CallTitanApi.asActorUsingService(actor, THIS_SERVICE).contentType("application/json").pathParam("id", id).get("channels/{id}");
			}
		);
	}
	...
	public static Performable deleteEmailRelayAccountUsingDeleteOnTheEmailRelayAccountController(){
		...
		"{0} Delete email relay account relay specific data", 
			actor -> {
				CallTitanApi.asActorUsingService(actor, THIS_SERVICE).contentType("application/json").delete("email-relays");
			}
		);
	}
	...
	public static Performable getChannelsByChannelTypeUsingGetOnTheChannelController(String channelType, String includeInactive, String pageSize, String page, String filter){
		...
		"{0} Get channels by channel type", 
			actor -> {
				CallTitanApi.asActorUsingService(actor, THIS_SERVICE).contentType("application/json").queryParam("channelType", channelType).queryParam("includeInactive", includeInactive).queryParam("pageSize", pageSize).queryParam("page", page).queryParam("filter", filter).get("channels?filter=byChannelType");
			}
		);
	}
	...
	public static Performable getAuthorizeUrlUsingGetOnTheOAuthController(String provider){
		...
		"{0} Get OAuth URL", 
			actor -> {
				CallTitanApi.asActorUsingService(actor, THIS_SERVICE).contentType("application/json").pathParam("provider", provider).get("oauth/{provider}/authorize-url");
			}
		);
	}
	...
	public static Performable updateMessageUsingPutOnTheEmailMessageController(String id, Object body){
		...
		"{0} Update a EmailMessage identified by the provided id", 
			actor -> {
				CallTitanApi.asActorUsingService(actor, THIS_SERVICE).contentType("application/json").pathParam("id", id).body(body).put("email-messages/{id}");
			}
		);
	}
	...
	public static Performable matchMessageUsingPostOnTheMessageController(String messageId, Object body){
		...
		"{0} Create a CustomerMatch for a Message", 
			actor -> {
				CallTitanApi.asActorUsingService(actor, THIS_SERVICE).contentType("application/json").pathParam("messageId", messageId).body(body).post("messages/{messageId}/match");
			}
		);
	}
	...
	public static Performable deleteSelectedSyncFolderUsingDeleteOnTheEmailMessageController(){
		...
		"{0} Delete User's Sync Folder for their Primary Email", 
			actor -> {
				CallTitanApi.asActorUsingService(actor, THIS_SERVICE).contentType("application/json").delete("sync-folder");
			}
		);
	}
	...
	public static Performable sendEmailUsingPostOnTheEmailController(Object body){
		...
		"{0} Send Email", 
			actor -> {
				CallTitanApi.asActorUsingService(actor, THIS_SERVICE).contentType("application/json").body(body).post("emails");
			}
		);
	}
	...
	public static Performable updateChannelUsingPutOnTheChannelController(String id, Object body){
		...
		"{0} Update channel", 
			actor -> {
				CallTitanApi.asActorUsingService(actor, THIS_SERVICE).contentType("application/json").pathParam("id", id).body(body).put("channels/{id}");
			}
		);
	}
