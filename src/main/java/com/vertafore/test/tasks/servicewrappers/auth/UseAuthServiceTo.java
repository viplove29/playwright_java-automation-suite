...
public class UseAuthServiceTo {
    ...
    return Task.where(
        ...
        actor -> {
          CallTitanApi.asActorUsingService(actor, THIS_SERVICE)
              ...
              .body(body)
              .put("products/{productIdToCreate}");
        });
  }
    ...
    return Task.where(
        ...
        actor -> {
          CallTitanApi.asActorUsingService(actor, THIS_SERVICE)
              ...
              .get("role-assignments?filter=byUserId");
        });
  }
    ...
    return Task.where(
        ...
        actor -> {
          CallTitanApi.asActorUsingService(actor, THIS_SERVICE)
              ...
              .delete("entities/{entityIdToDelete}");
        });
  }
    ...
    return Task.where(
        ...
        actor -> {
          CallTitanApi.asActorUsingService(actor, THIS_SERVICE)
              ...
              .queryParam("userId", userId)
              .queryParam("filter", filter)
              .get("entities?filter=byEntitlement");
        });
  }
    ...
    return Task.where(
        ...
        actor -> {
          CallTitanApi.asActorUsingService(actor, THIS_SERVICE)
              ...
              .get("auth-tree/services/{serviceName}");
        });
  }
    ...
    return Task.where(
        ...
        actor -> {
          CallTitanApi.asActorUsingService(actor, THIS_SERVICE)
              .contentType("application/json")
              .pathParam("serviceName", serviceName)
              .get("auth-info/services/{serviceName}");
        });
  }
    ...
    return Task.where(
        ...
        actor -> {
          CallTitanApi.asActorUsingService(actor, THIS_SERVICE)
              .contentType("application/json")
              .body(body)
              .put("authenticationsettings");
        });
  }

  public static Performable getUsersByAssignedRolesUsingGetOnTheUsersController(
      String roleIds,
      String activeFilter,
      String entityIds,
      String displayName,
      ...
      String filter) {
    return Task.where(
        "{0} Get a list of users who are assigned any role",
        actor -> {
          CallTitanApi.asActorUsingService(actor, THIS_SERVICE)
              .contentType("application/json")
              ...
              .queryParam("page", page)
              .queryParam("filter", filter)
              .get("users/assigned-roles?filter=ByAssignedRoles");
        });
  }
    ...
    return Task.where(
        ...
        actor -> {
          CallTitanApi.asActorUsingService(actor, THIS_SERVICE)
              ...
              .get("tenants/{tenantIdToRetrieve}");
        });
  }
    ...
    return Task.where(
        ...
        actor -> {
          CallTitanApi.asActorUsingService(actor, THIS_SERVICE)
              .contentType("application/json")
              .pathParam("serviceName", serviceName)
              .get("services/{serviceName}/roles");
        });
  }
    ...
    return Task.where(
        ...
        actor -> {
          CallTitanApi.asActorUsingService(actor, THIS_SERVICE)
              ...
              .get("entities/{entityIdToRetrieve}");
        });
  }
  ...
  public static Performable getUsersLastLoginTimesByIdsUsingGetOnTheUsersController(
      String ids, String filter) {
    return Task.where(
        "{0} Retrieve Users last login time by Ids",
        actor -> {
          CallTitanApi.asActorUsingService(actor, THIS_SERVICE)
              .contentType("application/json")
              .queryParam("ids", ids)
              .queryParam("filter", filter)
              .get("users/lastlogintimes?filter=byIds");
        });
  }
    ...
    return Task.where(
        ...
        actor -> {
          CallTitanApi.asActorUsingService(actor, THIS_SERVICE)
              ...
              .delete("tenants/{tenantIdToDelete}");
        });
  }
    ...
    return Task.where(
        ...
        actor -> {
          CallTitanApi.asActorUsingService(actor, THIS_SERVICE)
              ...
              .get("products/{productIdToRetrieve}");
        });
  }
    ...
    return Task.where(
        ...
        actor -> {
          CallTitanApi.asActorUsingService(actor, THIS_SERVICE)
              ...
              .pathParam("serviceName", serviceName)
              .body(body)
              .put("services/{serviceName}/roles");
        });
  }
    ...
    return Task.where(
        ...
        actor -> {
          CallTitanApi.asActorUsingService(actor, THIS_SERVICE)
              ...
              .pathParam("serviceName", serviceName)
              .pathParam("name", name)
              .get("services/{serviceName}/roles/{name}");
        });
  }
