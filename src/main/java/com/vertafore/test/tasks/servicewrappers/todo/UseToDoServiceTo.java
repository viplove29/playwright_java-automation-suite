...
public class UseToDoServiceTo {
  ...
  private static final String DELETE_USING_DELETE_ON_THE_TASK_ASSIGNEE_CONTROLLER =
      "tasks/{taskId}/assignees/{assigneeId}";
  private static final String FIND_A_TASK_NOTES_ON_THE_TASK_NOTE_CONTROLLER =
      "tasks/{taskId}/notes";
  private static final String GET_TASKS_BY_FILTER_USING_GET_ON_THE_TASK_CONTROLLER = "tasks";
  private static final String DELETE_A_TASK_NOTE_ON_THE_TASK_NOTE_CONTROLLER =
      "tasks/{taskId}/notes/{noteId}";
  private static final String UPDATE_USING_PUT_ON_THE_TASK_NOTE_CONTROLLER =
      "tasks/{taskId}/notes/{noteId}";
  private static final String CREATE_USING_POST_ON_THE_TASK_NOTE_CONTROLLER =
      "tasks/{taskId}/notes";
  private static final String CREATE_TASK_USING_POST_ON_THE_TASK_CONTROLLER = "tasks";
  private static final String BULK_UPDATE_TASK_STATUS_USING_PUT_ON_THE_TASK_CONTROLLER =
      "tasks/status";
  private static final String ASSIGN_USING_POST_ON_THE_TASK_ASSIGNEE_CONTROLLER =
      "tasks/{taskId}/assignees";
  private static final String FIND_BY_TASK_ID_USING_GET_ON_THE_TASK_ASSIGNEE_CONTROLLER =
      "tasks/{taskId}/assignees";
  private static final String GET_TASKS_BY_CUSTOMER_ID_USING_GET_ON_THE_TASK_CONTROLLER =
      "tasks?filter=byCustomerId";
    ...
    return Task.where(
        ...
        actor -> {
          CallTitanApi.asActorUsingService(actor, THIS_SERVICE)
              ...
              .pathParam("id", id)
              .body(body)
              .patch(UPDATE_TASK_USING_PATCH_ON_THE_TASK_CONTROLLER);
        });
  }
    ...
    return Task.where(
        ...
        actor -> {
          CallTitanApi.asActorUsingService(actor, THIS_SERVICE)
              ...
              .pathParam("id", id)
              .get(GET_TASK_BY_ID_USING_GET_ON_THE_TASK_CONTROLLER);
        });
  }
    ...
    return Task.where(
        ...
        actor -> {
          CallTitanApi.asActorUsingService(actor, THIS_SERVICE)
              ...
              .pathParam("id", id)
              .body(body)
              .put(REPLACE_TASK_USING_PUT_ON_THE_TASK_CONTROLLER);
        });
  }
    ...
    return Task.where(
        ...
        actor -> {
          CallTitanApi.asActorUsingService(actor, THIS_SERVICE)
              ...
              .delete(DELETE_USING_DELETE_ON_THE_TASK_ASSIGNEE_CONTROLLER);
        });
  }
    ...
    return Task.where(
        ...
        actor -> {
          CallTitanApi.asActorUsingService(actor, THIS_SERVICE)
              ...
              .get(FIND_A_TASK_NOTES_ON_THE_TASK_NOTE_CONTROLLER);
        });
  }
    ...
    return Task.where(
        ...
        actor -> {
          CallTitanApi.asActorUsingService(actor, THIS_SERVICE)
              ...
              .queryParam("pageSize", pageSize)
              .queryParam("page", page)
              .get(GET_TASKS_BY_FILTER_USING_GET_ON_THE_TASK_CONTROLLER);
        });
  }
    ...
    return Task.where(
        ...
        actor -> {
          CallTitanApi.asActorUsingService(actor, THIS_SERVICE)
              ...
              .delete(DELETE_A_TASK_NOTE_ON_THE_TASK_NOTE_CONTROLLER);
        });
  }
    ...
    return Task.where(
        ...
        actor -> {
          CallTitanApi.asActorUsingService(actor, THIS_SERVICE)
              ...
              .pathParam("noteId", noteId)
              .body(body)
              .put(UPDATE_USING_PUT_ON_THE_TASK_NOTE_CONTROLLER);
        });
  }
    ...
    return Task.where(
        ...
        actor -> {
          CallTitanApi.asActorUsingService(actor, THIS_SERVICE)
              ...
              .pathParam("taskId", taskId)
              .body(body)
              .post(CREATE_USING_POST_ON_THE_TASK_NOTE_CONTROLLER);
        });
  }
    ...
    return Task.where(
        ...
        actor -> {
          CallTitanApi.asActorUsingService(actor, THIS_SERVICE)
              .contentType("application/json")
              .body(body)
              .post(CREATE_TASK_USING_POST_ON_THE_TASK_CONTROLLER);
        });
  }
    ...
    return Task.where(
        ...
        actor -> {
          CallTitanApi.asActorUsingService(actor, THIS_SERVICE)
              .contentType("application/json")
              .body(body)
              .put(BULK_UPDATE_TASK_STATUS_USING_PUT_ON_THE_TASK_CONTROLLER);
        });
  }
    ...
    return Task.where(
        ...
        actor -> {
          CallTitanApi.asActorUsingService(actor, THIS_SERVICE)
              ...
              .body(body)
              .pathParam("taskId", taskId)
              .post(ASSIGN_USING_POST_ON_THE_TASK_ASSIGNEE_CONTROLLER);
        });
  }
    ...
    return Task.where(
        ...
        actor -> {
          CallTitanApi.asActorUsingService(actor, THIS_SERVICE)
              .contentType("application/json")
              .pathParam("taskId", taskId)
              .get(FIND_BY_TASK_ID_USING_GET_ON_THE_TASK_ASSIGNEE_CONTROLLER);
        });
  }
    ...
    return Task.where(
        ...
        actor -> {
          CallTitanApi.asActorUsingService(actor, THIS_SERVICE)
              ...
              .get(GET_TASKS_BY_CUSTOMER_ID_USING_GET_ON_THE_TASK_CONTROLLER);
        });
  }
}
