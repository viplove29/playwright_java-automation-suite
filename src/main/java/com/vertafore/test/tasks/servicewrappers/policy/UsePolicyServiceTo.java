...
public class UsePolicyServiceTo {
  ...
  private static final String GET_POLICIES_BY_IDS_USING_GET_ON_THE_POLICY_CONTROLLER =
      "policies?filter=byIds";
  private static final String GET_POLICIES_BY_CONTEXTUAL_IDS_USING_GET_ON_THE_POLICY_CONTROLLER =
      "policies?filter=byContextualIds";
  ...
  private static final String GET_POLICIES_BY_STATUSES_USING_GET_ON_THE_POLICY_CONTROLLER =
      "policies?filter=byStatuses";
  private static final String CREATE_POLICY_USING_POST_ON_THE_POLICY_CONTROLLER = "policies";
  private static final String UPDATE_POLICY_VERSION_USING_PATCH_ON_THE_POLICY_VERSION_CONTROLLER =
      "policies/{policyId}/versions/{versionId}";
  private static final String GET_POLICY_VERSION_USING_GET_ON_THE_POLICY_VERSION_CONTROLLER =
      "policies/{policyId}/versions/{versionId}";
  private static final String
      GET_ALL_VERSIONS_BY_POLICY_ID_USING_GET_ON_THE_POLICY_VERSION_CONTROLLER =
          "policies/{id}/versions";
  private static final String SEARCH_POLICIES_USING_GET_ON_THE_POLICY_CONTROLLER = "policies";
  private static final String GET_CARRIERS_FOR_ALL_POLICIES_USING_GET_ON_THE_POLICY_CONTROLLER =
      "policies/carriers";
  private static final String CREATE_POLICY_VERSION_USING_POST_ON_THE_POLICY_VERSION_CONTROLLER =
    ...
    return Task.where(
        ...
        actor -> {
          CallTitanApi.asActorUsingService(actor, THIS_SERVICE)
              ...
              .get(GET_POLICIES_BY_IDS_USING_GET_ON_THE_POLICY_CONTROLLER);
        });
  }
    ...
    return Task.where(
        ...
        actor -> {
          CallTitanApi.asActorUsingService(actor, THIS_SERVICE)
              ...
              .queryParam("ids", ids)
              .queryParam("filter", filter)
              .get(GET_POLICIES_BY_CONTEXTUAL_IDS_USING_GET_ON_THE_POLICY_CONTROLLER);
        });
  }
    ...
    return Task.where(
        ...
        actor -> {
          CallTitanApi.asActorUsingService(actor, THIS_SERVICE)
              .contentType("application/json")
              .pathParam("id", id)
              .get(GET_POLICY_BY_ID_USING_GET_ON_THE_POLICY_CONTROLLER);
        });
  }
    ...
    return Task.where(
        ...
        actor -> {
          CallTitanApi.asActorUsingService(actor, THIS_SERVICE)
              .contentType("application/json")
              .pathParam("id", id)
              .delete(DELETE_POLICY_USING_DELETE_ON_THE_POLICY_CONTROLLER);
        });
  }
    ...
    return Task.where(
        ...
        actor -> {
          CallTitanApi.asActorUsingService(actor, THIS_SERVICE)
              ...
              .queryParam("filter", filter)
              .get(GET_POLICIES_BY_STATUSES_USING_GET_ON_THE_POLICY_CONTROLLER);
        });
  }
    ...
    return Task.where(
        ...
        actor -> {
          CallTitanApi.asActorUsingService(actor, THIS_SERVICE)
              .contentType("application/json")
              .body(body)
              .post(CREATE_POLICY_USING_POST_ON_THE_POLICY_CONTROLLER);
        });
  }
    ...
    return Task.where(
        ...
        actor -> {
          CallTitanApi.asActorUsingService(actor, THIS_SERVICE)
              ...
              .patch(UPDATE_POLICY_VERSION_USING_PATCH_ON_THE_POLICY_VERSION_CONTROLLER);
        });
  }
    ...
    return Task.where(
        ...
        actor -> {
          CallTitanApi.asActorUsingService(actor, THIS_SERVICE)
              ...
              .pathParam("policyId", policyId)
              .pathParam("versionId", versionId)
              .get(GET_POLICY_VERSION_USING_GET_ON_THE_POLICY_VERSION_CONTROLLER);
        });
  }
    ...
    return Task.where(
        ...
        actor -> {
          CallTitanApi.asActorUsingService(actor, THIS_SERVICE)
              ...
              .queryParam("pageSize", pageSize)
              .queryParam("page", page)
              .get(GET_ALL_VERSIONS_BY_POLICY_ID_USING_GET_ON_THE_POLICY_VERSION_CONTROLLER);
        });
  }
    ...
    return Task.where(
        ...
        actor -> {
          CallTitanApi.asActorUsingService(actor, THIS_SERVICE)
              ...
              .queryParam("pageSize", pageSize)
              .queryParam("page", page)
              .get(SEARCH_POLICIES_USING_GET_ON_THE_POLICY_CONTROLLER);
        });
  }
    ...
    return Task.where(
        ...
        actor -> {
          CallTitanApi.asActorUsingService(actor, THIS_SERVICE)
              ...
              .queryParam("pageSize", pageSize)
              .queryParam("page", page)
              .get(GET_CARRIERS_FOR_ALL_POLICIES_USING_GET_ON_THE_POLICY_CONTROLLER);
        });
  }
    ...
    return Task.where(
        ...
        actor -> {
          CallTitanApi.asActorUsingService(actor, THIS_SERVICE)
              ...
              .pathParam("policyId", policyId)
              .body(body)
              .post(CREATE_POLICY_VERSION_USING_POST_ON_THE_POLICY_VERSION_CONTROLLER);
        });
  }
}
