...
public class UseQuickbooksIntegrationServiceTo {
  ...
  private static final String RETRIEVE_QUICK_BOOKS_INTEGRATION_STATUS_USING_GET =
    ...
    return Task.where(
        ...
        actor -> {
          rest()
              ...
              .get(as(actor).toEndpoint(GET_QUICK_BOOKS_ACCOUNTS_USING_GET));
        });
  }
    ...
    return Task.where(
        ...
        actor -> {
          rest()
              .with()
              .contentType("application/json")
              .get(as(actor).toEndpoint(CONNECT_TO_QUICK_BOOKS_USING_GET));
        });
  }
    ...
    return Task.where(
        ...
        actor -> {
          rest()
              .with()
              .contentType("application/json")
              .get(as(actor).toEndpoint(RETRIEVE_QUICK_BOOKS_INTEGRATION_STATUS_USING_GET));
        });
  }
    ...
    return Task.where(
        ...
        actor -> {
          rest()
              .with()
              .contentType("application/json")
              .delete(as(actor).toEndpoint(DELETE_AUTHORIZATION_CREDENTIAL_USING_DELETE));
        });
  }
    ...
    return Task.where(
        ...
        actor -> {
          rest()
              ...
              .contentType("application/json")
              .body(body)
              .put(as(actor).toEndpoint(PUT_AUTHORIZATION_CREDENTIAL_USING_PUT));
        });
  }
    ...
    return Task.where(
        ...
        actor -> {
          rest()
              ...
              .body(body)
              .patch(as(actor).toEndpoint(UPDATE_ACCOUNT_MAPPING_USING_PATCH));
        });
  }
    ...
    return Task.where(
        ...
        actor -> {
          rest()
              ...
              .pathParam("accountId", accountId)
              .body(body)
              .post(as(actor).toEndpoint(CREATE_ACCOUNT_MAPPING_USING_POST));
        });
  }
    ...
    return Task.where(
        ...
        actor -> {
          rest()
              ...
              .contentType("application/json")
              .pathParam("accountId", accountId)
              .get(as(actor).toEndpoint(GET_ACCOUNT_MAPPING_USING_GET));
        });
  }
}
