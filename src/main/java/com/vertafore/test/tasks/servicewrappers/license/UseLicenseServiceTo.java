...
public class UseLicenseServiceTo {
  ...
  public static Performable updateLicenseForCustomerUsingPutOnTheLicenseController(
      Object body, String vertaforeCustomerId) {
    return Task.where(
        ...
        actor -> {
          CallTitanApi.asActorUsingService(actor, THIS_SERVICE)
              ...
              .body(body)
              .pathParam("vertaforeCustomerId", vertaforeCustomerId)
              .put("licenses/{vertaforeCustomerId}");
        });
  }
