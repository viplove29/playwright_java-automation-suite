...
/** This class was automatically generated on 2020/03/30 11:16:45 */
public class UseAlertServiceTo {
  ...
  public static Performable getAlertsByUserIdUsingGetOnTheAlertController(
  ...
  public static Performable updateAlertPreferencesUsingPutOnTheAlertPreferencesController(
      Object body) {
    return Task.where(
