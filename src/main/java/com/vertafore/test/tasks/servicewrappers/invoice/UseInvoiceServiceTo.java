...
public class UseInvoiceServiceTo {
  ...
  private static final String GET_INVOICE_SETTINGS_USING_GET_ON_THE_SETTINGS_CONTROLLER =
      "setting-groups/invoices";
  private static final String SET_INVOICE_SETTINGS_USING_PUT_ON_THE_SETTINGS_CONTROLLER =
      "setting-groups/invoices";
  private static final String GET_PAYMENTS_BY_INVOICE_ID_USING_GET_ON_THE_PAYMENTS_CONTROLLER =
      "invoices/{id}/payments";
  private static final String GET_PAYMENT_USING_GET_ON_THE_PAYMENTS_CONTROLLER = "payments/{id}";
  private static final String DELETE_PAYMENT_USING_DELETE_ON_THE_PAYMENTS_CONTROLLER =
      "payments/{id}";
  private static final String UPDATE_PAYMENT_USING_PUT_ON_THE_PAYMENTS_CONTROLLER = "payments/{id}";
  private static final String PATCH_CHARGE_USING_PATCH_ON_THE_CHARGE_CONTROLLER =
      "charges/{chargeId}";
  private static final String GET_CHARGE_USING_GET_ON_THE_CHARGE_CONTROLLER = "charges/{chargeId}";
  private static final String UPDATE_CHARGE_USING_PUT_ON_THE_CHARGE_CONTROLLER =
      "charges/{chargeId}";
  private static final String SEARCH_FOR_INVOICES_USING_GET_ON_THE_INVOICE_CONTROLLER =
      "invoices?filter=bySearchTerm";
  private static final String GET_INVOICE_BY_IDS_USING_GET_ON_THE_INVOICE_CONTROLLER =
      "invoices?filter=byIds";
  private static final String CREATE_PAYMENT_USING_POST_ON_THE_PAYMENTS_CONTROLLER = "payments";
  private static final String FORMAT_INVOICE_LINE_ITEM_USING_POST_ON_THE_CHARGE_CONTROLLER =
      "invoice-line-item";
  ...
  private static final String GET_CHARGES_USING_GET_ON_THE_CHARGE_CONTROLLER =
      "charges?sortField=TITLE{&searchTerm,status,isSystemCharge,isDescending,pageSize,page}";
  private static final String GET_PAYMENT_BY_IDS_USING_GET_ON_THE_PAYMENTS_CONTROLLER =
      "payments?filter=byIds";
  ...
  private static final String DELETE_INVOICE_USING_DELETE_ON_THE_INVOICE_CONTROLLER =
      "invoices/{id}";
  private static final String CREATE_CUSTOMER_INVOICE_RENDER_USING_POST_ON_THE_INVOICE_CONTROLLER =
      "invoices/{id}/customer-invoices";
  private static final String RETRIEVE_STORED_CUSTOMER_INVOICE_USING_GET_ON_THE_INVOICE_CONTROLLER =
      "invoices/{id}/customer-invoices";
  private static final String GET_BASIC_INVOICE_INFO_USING_GET_ON_THE_INVOICE_CONTROLLER =
      "invoices/basic-info";
  private static final String GET_APPLICABLE_POLICY_CHARGES_USING_GET_ON_THE_CHARGE_CONTROLLER =
      "charges/policy-charges/{policyId}";
  private static final String GET_PAYMENT_PRIORITY_SETTINGS_USING_GET_ON_THE_SETTINGS_CONTROLLER =
      "setting-groups/payment-priority";
  private static final String SET_PAYMENT_PRIORITY_SETTINGS_USING_PUT_ON_THE_SETTINGS_CONTROLLER =
      "setting-groups/payment-priority";
  private static final String GET_THRESHOLD_SETTINGS_USING_GET_ON_THE_SETTINGS_CONTROLLER =
      "setting-groups/thresholds";
  private static final String SET_THRESHOLD_SETTINGS_USING_PUT_ON_THE_SETTINGS_CONTROLLER =
      "setting-groups/thresholds";
  private static final String CREATE_CHARGE_USING_POST_ON_THE_CHARGE_CONTROLLER = "charges";
  private static final String GET_LATE_FEES_SETTINGS_USING_GET_ON_THE_SETTINGS_CONTROLLER =
      "setting-groups/late-fees";
  private static final String SET_LATE_FEE_SETTINGS_USING_PUT_ON_THE_SETTINGS_CONTROLLER =
      "setting-groups/late-fees";
    ...
    return Task.where(
        ...
        actor -> {
          CallTitanApi.asActorUsingService(actor, THIS_SERVICE)
              ...
              .get(GET_INVOICE_SETTINGS_USING_GET_ON_THE_SETTINGS_CONTROLLER);
        });
  }
    ...
    return Task.where(
        ...
        actor -> {
          CallTitanApi.asActorUsingService(actor, THIS_SERVICE)
              .contentType("application/json")
              .body(body)
              .put(SET_INVOICE_SETTINGS_USING_PUT_ON_THE_SETTINGS_CONTROLLER);
        });
  }
    ...
    return Task.where(
        ...
        actor -> {
          CallTitanApi.asActorUsingService(actor, THIS_SERVICE)
              ...
              .get(GET_PAYMENTS_BY_INVOICE_ID_USING_GET_ON_THE_PAYMENTS_CONTROLLER);
        });
  }
    ...
    return Task.where(
        ...
        actor -> {
          CallTitanApi.asActorUsingService(actor, THIS_SERVICE)
              .contentType("application/json")
              .pathParam("id", id)
              .get(GET_PAYMENT_USING_GET_ON_THE_PAYMENTS_CONTROLLER);
        });
  }
    ...
    return Task.where(
        ...
        actor -> {
          CallTitanApi.asActorUsingService(actor, THIS_SERVICE)
              .contentType("application/json")
              .pathParam("id", id)
              .delete(DELETE_PAYMENT_USING_DELETE_ON_THE_PAYMENTS_CONTROLLER);
        });
  }
    ...
    return Task.where(
        ...
        actor -> {
          CallTitanApi.asActorUsingService(actor, THIS_SERVICE)
              ...
              .pathParam("id", id)
              .body(body)
              .put(UPDATE_PAYMENT_USING_PUT_ON_THE_PAYMENTS_CONTROLLER);
        });
  }
    ...
    return Task.where(
        ...
        actor -> {
          CallTitanApi.asActorUsingService(actor, THIS_SERVICE)
              ...
              .body(body)
              .patch(PATCH_CHARGE_USING_PATCH_ON_THE_CHARGE_CONTROLLER);
        });
  }
    ...
    return Task.where(
        ...
        actor -> {
          CallTitanApi.asActorUsingService(actor, THIS_SERVICE)
              .contentType("application/json")
              .pathParam("chargeId", chargeId)
              .get(GET_CHARGE_USING_GET_ON_THE_CHARGE_CONTROLLER);
        });
  }
    ...
    return Task.where(
        ...
        actor -> {
          CallTitanApi.asActorUsingService(actor, THIS_SERVICE)
              ...
              .pathParam("chargeId", chargeId)
              .body(body)
              .put(UPDATE_CHARGE_USING_PUT_ON_THE_CHARGE_CONTROLLER);
        });
  }
    ...
    return Task.where(
        ...
        actor -> {
          CallTitanApi.asActorUsingService(actor, THIS_SERVICE)
              ...
              .get(SEARCH_FOR_INVOICES_USING_GET_ON_THE_INVOICE_CONTROLLER);
        });
  }
    ...
    return Task.where(
        ...
        actor -> {
          CallTitanApi.asActorUsingService(actor, THIS_SERVICE)
              ...
              .queryParam("page", page)
              .queryParam("filter", filter)
              .get(GET_INVOICE_BY_IDS_USING_GET_ON_THE_INVOICE_CONTROLLER);
        });
  }
    ...
    return Task.where(
        ...
        actor -> {
          CallTitanApi.asActorUsingService(actor, THIS_SERVICE)
              .contentType("application/json")
              .body(body)
              .post(CREATE_PAYMENT_USING_POST_ON_THE_PAYMENTS_CONTROLLER);
        });
  }
    ...
    return Task.where(
        ...
        actor -> {
          CallTitanApi.asActorUsingService(actor, THIS_SERVICE)
              .contentType("application/json")
              .body(body)
              .post(FORMAT_INVOICE_LINE_ITEM_USING_POST_ON_THE_CHARGE_CONTROLLER);
        });
  }
    ...
    return Task.where(
        ...
        actor -> {
          CallTitanApi.asActorUsingService(actor, THIS_SERVICE)
              .contentType("application/json")
              .body(body)
              .post(CREATE_INVOICE_USING_POST_ON_THE_INVOICE_CONTROLLER);
        });
  }
    ...
    return Task.where(
        ...
        actor -> {
          CallTitanApi.asActorUsingService(actor, THIS_SERVICE)
              .contentType("application/json")
              .pathParam("id", id)
              .delete(DELETE_CHARGE_USING_DELETE_ON_THE_CHARGE_CONTROLLER);
        });
  }
    ...
    return Task.where(
        ...
        actor -> {
          CallTitanApi.asActorUsingService(actor, THIS_SERVICE)
              ...
              .queryParam("pageSize", pageSize)
              .queryParam("page", page)
              .get(GET_CHARGES_USING_GET_ON_THE_CHARGE_CONTROLLER);
        });
  }
    ...
    return Task.where(
        ...
        actor -> {
          CallTitanApi.asActorUsingService(actor, THIS_SERVICE)
              ...
              .queryParam("page", page)
              .queryParam("filter", filter)
              .get(GET_PAYMENT_BY_IDS_USING_GET_ON_THE_PAYMENTS_CONTROLLER);
        });
  }
    ...
    return Task.where(
        ...
        actor -> {
          CallTitanApi.asActorUsingService(actor, THIS_SERVICE)
              ...
              .queryParam("pageSize", pageSize)
              .queryParam("page", page)
              .get(GET_INVOICES_USING_GET_ON_THE_INVOICE_CONTROLLER);
        });
  }
    ...
    return Task.where(
        ...
        actor -> {
          CallTitanApi.asActorUsingService(actor, THIS_SERVICE)
              .contentType("application/json")
              .pathParam("id", id)
              .get(GET_INVOICE_USING_GET_ON_THE_INVOICE_CONTROLLER);
        });
  }
    ...
    return Task.where(
        ...
        actor -> {
          CallTitanApi.asActorUsingService(actor, THIS_SERVICE)
              .contentType("application/json")
              .pathParam("id", id)
              .delete(DELETE_INVOICE_USING_DELETE_ON_THE_INVOICE_CONTROLLER);
        });
  }
    ...
    return Task.where(
        ...
        actor -> {
          CallTitanApi.asActorUsingService(actor, THIS_SERVICE)
              .contentType("application/json")
              .pathParam("id", id)
              .post(CREATE_CUSTOMER_INVOICE_RENDER_USING_POST_ON_THE_INVOICE_CONTROLLER);
        });
  }
    ...
    return Task.where(
        ...
        actor -> {
          CallTitanApi.asActorUsingService(actor, THIS_SERVICE)
              .contentType("application/json")
              .pathParam("id", id)
              .get(RETRIEVE_STORED_CUSTOMER_INVOICE_USING_GET_ON_THE_INVOICE_CONTROLLER);
        });
  }
    ...
    return Task.where(
        ...
        actor -> {
          CallTitanApi.asActorUsingService(actor, THIS_SERVICE)
              ...
              .get(GET_BASIC_INVOICE_INFO_USING_GET_ON_THE_INVOICE_CONTROLLER);
        });
  }
    ...
    return Task.where(
        ...
        actor -> {
          CallTitanApi.asActorUsingService(actor, THIS_SERVICE)
              ...
              .queryParam("pageSize", pageSize)
              .queryParam("page", page)
              .get(GET_APPLICABLE_POLICY_CHARGES_USING_GET_ON_THE_CHARGE_CONTROLLER);
        });
  }
  ...
  public static Performable getPaymentPrioritySettingsUsingGetOnTheSettingsController() {
    return Task.where(
        ...
        actor -> {
          CallTitanApi.asActorUsingService(actor, THIS_SERVICE)
              .contentType("application/json")
              .get(GET_PAYMENT_PRIORITY_SETTINGS_USING_GET_ON_THE_SETTINGS_CONTROLLER);
        });
  }
    ...
    return Task.where(
        ...
        actor -> {
          CallTitanApi.asActorUsingService(actor, THIS_SERVICE)
              .contentType("application/json")
              .body(body)
              .put(SET_PAYMENT_PRIORITY_SETTINGS_USING_PUT_ON_THE_SETTINGS_CONTROLLER);
        });
  }
  ...
  public static Performable getThresholdSettingsUsingGetOnTheSettingsController() {
    return Task.where(
        ...
        actor -> {
          CallTitanApi.asActorUsingService(actor, THIS_SERVICE)
              .contentType("application/json")
              .get(GET_THRESHOLD_SETTINGS_USING_GET_ON_THE_SETTINGS_CONTROLLER);
        });
  }
    ...
    return Task.where(
        ...
        actor -> {
          CallTitanApi.asActorUsingService(actor, THIS_SERVICE)
              .contentType("application/json")
              .body(body)
              .put(SET_THRESHOLD_SETTINGS_USING_PUT_ON_THE_SETTINGS_CONTROLLER);
        });
  }
    ...
    return Task.where(
        ...
        actor -> {
          CallTitanApi.asActorUsingService(actor, THIS_SERVICE)
              .contentType("application/json")
              .body(body)
              .post(CREATE_CHARGE_USING_POST_ON_THE_CHARGE_CONTROLLER);
        });
  }
  ...
  public static Performable getLateFeesSettingsUsingGetOnTheSettingsController() {
    return Task.where(
        ...
        actor -> {
          CallTitanApi.asActorUsingService(actor, THIS_SERVICE)
              .contentType("application/json")
              .get(GET_LATE_FEES_SETTINGS_USING_GET_ON_THE_SETTINGS_CONTROLLER);
        });
  }
    ...
    return Task.where(
        ...
        actor -> {
          CallTitanApi.asActorUsingService(actor, THIS_SERVICE)
              .contentType("application/json")
              .body(body)
              .put(SET_LATE_FEE_SETTINGS_USING_PUT_ON_THE_SETTINGS_CONTROLLER);
        });
  }
    ...
    return Task.where(
        ...
        actor -> {
          CallTitanApi.asActorUsingService(actor, THIS_SERVICE)
              ...
              .queryParam("pageSize", pageSize)
              .queryParam("page", page)
              .get(GET_PAYMENTS_USING_GET_ON_THE_PAYMENTS_CONTROLLER);
        });
  }
}
